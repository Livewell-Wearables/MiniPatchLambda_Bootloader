...
typedef enum
{
	...
	USB_FIRMWARE_CMD_EXIT_BOOTLOADER	= 0x17,		// PC  - - - > MCU
	USB_FIRMWARE_CMD_SHUTDOWN_DEVICE	= 0x18,		// PC  - - - > MCU
	USB_FIRMWARE_CMD_GO_APPLICATION		= 0x19,		// PC  - - - > MCU
	USB_FIRMWARE_CMD_RESET_DEVICE		= 0x20,		// PC  - - - > MCU

	USB_FIRMWARE_JUMPING_APPLICATION	= 0x21,     // MCU - - - > PC
    USB_FIRMWARE_BOOTLOADER_VERSION     = 0x22
